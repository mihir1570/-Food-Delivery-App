...
import 'package:flutter_app/data/api/api_checker.dart';
...
class LocationController extends GetxController implements GetxService {
  ...
  Future<ResponseModel> getZone(String lat, String lng, bool markerLoad) async {
    ...
    // print("zone response code is "+response.statusCode.toString()); //200 //400 //500 //403 error codes for debugging
    update();
